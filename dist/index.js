...
import { z } from "zod";
import { loadConfig, pickBot } from "./config.js";
import { sessionFor } from "./telegram.js";
import { ask, receipt, markExpired, refuse, heartbeat, deliver } from "./ask.js";
import { touch, release } from "./registry.js";
 ...
 */
function checkIn(botName, bot, caller) {
...
function conflictWarning(session, bot, mine, other) {
...
server.registerTool("send_to_user", {
